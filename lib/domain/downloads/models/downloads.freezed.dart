...
abstract class $DownloadsCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "poster _path") String? PosterPath});
}
...
class _$_Downloads implements _Downloads {
  const _$_Downloads({@JsonKey(name: "poster _path") required this.PosterPath});
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
          {@JsonKey(name: "poster _path") required final String? PosterPath}) =
      _$_Downloads;
